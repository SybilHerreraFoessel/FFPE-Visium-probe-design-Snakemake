...
config.yaml:
1) blast_db_dir: "/home/sybil.hf/cross_hybridization/blast_db_experimental/db" # define your database directory for checking for cross-hybridization in part2
2) blast_dbs:
  - "env_nt"
  - "nt_prok"
  - "nt_viruses"
